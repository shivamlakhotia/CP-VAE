...
def main(args):
    ...
    train_pth = os.path.join(data_pth, "train_identical_%s.txt" % args.style)
    dev_pth = os.path.join(data_pth, "dev_identical_%s.txt" % args.style)
    test_pth = os.path.join(data_pth, "test_identical_%s.txt" % args.style)
    ...
    path = "checkpoint/identical-{}-{}-classifier.pt".format(args.data_name,args.style)
