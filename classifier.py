...
def main(args):
    ...
    train_pth = os.path.join(data_pth, "train_%s_data.txt" % args.style)
    dev_pth = os.path.join(data_pth, "dev_%s_data.txt" % args.style)
    test_pth = os.path.join(data_pth, "test_%s_data.txt" % args.style)
    ...
    path = "checkpoint/{}-{}-classifier.pt".format(args.data_name,args.style)
